...
void precond_rcs(fsi_linear_solver::FSILS_lhsType& lhs,
  ...
  //
  auto max_func = [](const double& a, const double& b) {
  ...
  while (flag) {
    ...
    switch (dof) {
      case 1:
        for (int Ac = 0; Ac < nNo; Ac++) {
          ...
          Wr(0, Ac) =
              fabs(*std::max_element(values.begin(), values.end(), max_func));
      ...
      case 2:
        for (int Ac = 0; Ac < nNo; Ac++) {
          ...
          Wr(0, Ac) =
              fabs(*std::max_element(vals1.begin(), vals1.end(), max_func));

          auto vals2 = Val.values({2, 3}, {a, b});
          Wr(1, Ac) =
              fabs(*std::max_element(vals2.begin(), vals2.end(), max_func));
      ...
      case 3:
        for (int Ac = 0; Ac < nNo; Ac++) {
          ...
          Wr(2, Ac) =
              fabs(*std::max_element(vals3.begin(), vals3.end(), max_func));
      ...
      case 4:
        for (int Ac = 0; Ac < nNo; Ac++) {
          ...
          Wr(3, Ac) =
              fabs(*std::max_element(vals4.begin(), vals4.end(), max_func));
      ...
      default:
        for (int Ac = 0; Ac < nNo; Ac++) {
          ...
          for (int i = 0; i < dof; i++) {
            ...
            Wr(i, Ac) =
                fabs(*std::max_element(vals.begin(), vals.end(), max_func));
          }
    ...
    if (lhs.commu.nTasks > 1) {
      ...
      MPI_Allgather(&iflag, 1, cm_mod::mplog, gflag.data(), 1, cm_mod::mplog,
                    lhs.commu.comm);
