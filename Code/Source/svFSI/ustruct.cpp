...
void b_ustruct_2d(const ComMod& com_mod, const int eNoN, const double w,
...
void b_ustruct_3d(const ComMod& com_mod, const int eNoN, const double w,
                  const Vector<double>& N, const Array<double>& Nx,
                  const Array<double>& dl, const Vector<double>& hl,
                  const Vector<double>& nV, Array<double>& lR,
                  Array3<double>& lK, Array3<double>& lKd)
{
  ...
  for (int a = 0; a < eNoN; a++) {
    NxFi(0, a) =
        Nx(0, a) * Fi(0, 0) + Nx(1, a) * Fi(1, 0) + Nx(2, a) * Fi(2, 0);
    NxFi(1, a) =
        Nx(0, a) * Fi(0, 1) + Nx(1, a) * Fi(1, 1) + Nx(2, a) * Fi(2, 1);
    NxFi(2, a) =
        Nx(1, a) * Fi(1, 2) + Nx(1, a) * Fi(1, 2) + Nx(2, a) * Fi(2, 2);
  }
  ...
  for (int e = 0; e < lM.nEl; e++) {
    ...
    for (int g = 0; g < fs[0].nG; g++) {
      if (g == 0 || !fs[0].lShpF) {
        ...
        if (utils::is_zero(Jac)) {
          throw std::runtime_error("[construct_usolid] Jacobian for element " +
      ...
      if (nsd == 3) {
        ...
        ustruct_3d_m(com_mod, cep_mod, vmsStab, fs[0].eNoN, fs[1].eNoN, nFn, w,
                     Jac, N0, N1, Nwx, al, yl, dl, bfl, fN, ya_l, lR, lK, lKd);
    ...
    for (int g = 0; g < fs[1].nG; g++) {
      ...
      if (nsd == 3) {
        auto N0 = fs[0].N.col(g);
        auto N1 = fs[1].N.col(g);
        ustruct_3d_c(com_mod, cep_mod, vmsStab, fs[0].eNoN, fs[1].eNoN, w, Jac,
                     N0, N1, Nwx, Nqx, al, yl, dl, bfl, ksix, lR, lK, lKd);

      } else if (nsd == 2) {
        auto N0 = fs[0].N.col(g);
        auto N1 = fs[1].N.col(g);
        ustruct_2d_c(com_mod, cep_mod, vmsStab, fs[0].eNoN, fs[1].eNoN, w, Jac,
                     N0, N1, Nwx, Nqx, al, yl, dl, bfl, ksix, lR, lK, lKd);
      }
    ...
    if (eq.assmTLS) {
      throw std::runtime_error(
          "[construct_usolid] Cannot assemble USTRUCT using Trilinos");
    }
#endif
...
//
void ustruct_2d_c(ComMod& com_mod, CepMod& cep_mod, const bool vmsFlag,
                  const int eNoNw, const int eNoNq, const double w,
                  const double Je, const Vector<double>& Nw,
...
//
void ustruct_3d_c(ComMod& com_mod, CepMod& cep_mod, const bool vmsFlag,
                  const int eNoNw, const int eNoNq, const double w,
                  const double Je, const Vector<double>& Nw,
                  const Vector<double>& Nq, const Array<double>& Nwx,
                  const Array<double>& Nqx, const Array<double>& al,
...
#define n_debug_ustruct_3d_c
  ...
  if (vmsFlag) {
    ...
    double tauV =
        Kx(0, 0) * Kx(0, 0) + Kx(1, 0) * Kx(1, 0) + Kx(2, 0) * Kx(2, 0) +
  ...
  for (int a = 0; a < eNoNw; a++) {
    NwxFi(0, a) =
        Nwx(0, a) * Fi(0, 0) + Nwx(1, a) * Fi(1, 0) + Nwx(2, a) * Fi(2, 0);
    NwxFi(1, a) =
        Nwx(0, a) * Fi(0, 1) + Nwx(1, a) * Fi(1, 1) + Nwx(2, a) * Fi(2, 1);
    NwxFi(2, a) =
        Nwx(0, a) * Fi(0, 2) + Nwx(1, a) * Fi(1, 2) + Nwx(2, a) * Fi(2, 2);
  }
  ...
  for (int a = 0; a < eNoNq; a++) {
    NqxFi(0, a) =
        Nqx(0, a) * Fi(0, 0) + Nqx(1, a) * Fi(1, 0) + Nqx(2, a) * Fi(2, 0);
    NqxFi(1, a) =
        Nqx(0, a) * Fi(0, 1) + Nqx(1, a) * Fi(1, 1) + Nqx(2, a) * Fi(2, 1);
    NqxFi(2, a) =
        Nqx(0, a) * Fi(0, 2) + Nqx(1, a) * Fi(1, 2) + Nqx(2, a) * Fi(2, 2);
  }
  ...
  for (int a = 0; a < eNoNw; a++) {
    ...
    VxNwx(1, a) = VxFi(0, 1) * NwxFi(0, a) + VxFi(1, 1) * NwxFi(1, a) +
                  VxFi(2, 1) * NwxFi(2, a);
    VxNwx(2, a) = VxFi(0, 2) * NwxFi(0, a) + VxFi(1, 2) * NwxFi(1, a) +
                  VxFi(2, 2) * NwxFi(2, a);
  }
...
#define n_debug_ustruct_2d_m
  ...
  double Ja = 0;
  mat_models::get_pk2cc_dev(com_mod, cep_mod, eq.dmn[cDmn], F, nFn, fN, ya_g,
                            Siso, Dm, Ja);
  ...
  // Tangent (stiffness) matrices
  //
  double NxSNx{0.0}, NxNx{0.0}, BtDB{0.0}, T1{0.0}, T2{0.0}, T3{0.0}, Tv{0.0},
      Ku{0.0};
  ...
  for (int b = 0; b < eNoNw; b++) {
    for (int a = 0; a < eNoNw; a++) {
      ...
      DBm(0, 0) = Dm(0, 0) * Bm(0, 0, b) + Dm(0, 1) * Bm(1, 0, b) +
                  Dm(0, 2) * Bm(2, 0, b);
      DBm(0, 1) = Dm(0, 0) * Bm(0, 1, b) + Dm(0, 1) * Bm(1, 1, b) +
                  Dm(0, 2) * Bm(2, 1, b);

      DBm(1, 0) = Dm(1, 0) * Bm(0, 0, b) + Dm(1, 1) * Bm(1, 0, b) +
                  Dm(1, 2) * Bm(2, 0, b);
      DBm(1, 1) = Dm(1, 0) * Bm(0, 1, b) + Dm(1, 1) * Bm(1, 1, b) +
                  Dm(1, 2) * Bm(2, 1, b);

      DBm(2, 0) = Dm(2, 0) * Bm(0, 0, b) + Dm(2, 1) * Bm(1, 0, b) +
                  Dm(2, 2) * Bm(2, 0, b);
      DBm(2, 1) = Dm(2, 0) * Bm(0, 1, b) + Dm(2, 1) * Bm(1, 1, b) +
                  Dm(2, 2) * Bm(2, 1, b);
      ...
      Tv = af * mu * Jac * (NxFi(1, a) * NxFi(0, b) - NxFi(0, a) * NxFi(1, b));
      ...
      Tv = af * mu * Jac * (NxFi(0, a) * NxFi(1, b) - NxFi(1, a) * NxFi(0, b));
...
#define n_debug_ustruct_3d_m
  ...
  for (int a = 0; a < eNoNw; a++) {
    ...
    T2 = Pdev(0, 0) * Nwx(0, a) + Pdev(0, 1) * Nwx(1, a) +
         Pdev(0, 2) * Nwx(2, a);
    T3 = Jac * rCl * NxFi(0, a);
    lR(0, a) = lR(0, a) + w * (T1 + T2 + T3);
    ...
    T2 = Pdev(2, 0) * Nwx(0, a) + Pdev(2, 1) * Nwx(1, a) +
         Pdev(2, 2) * Nwx(2, a);
    T3 = Jac * rCl * NxFi(2, a);
  ...
  for (int a = 0; a < eNoNw; a++) {
    ...
    DdNx(1, a) = ddev(1, 0) * NxFi(0, a) + ddev(1, 1) * NxFi(1, a) +
                 ddev(1, 2) * NxFi(2, a);
    DdNx(2, a) = ddev(2, 0) * NxFi(0, a) + ddev(2, 1) * NxFi(1, a) +
                 ddev(2, 2) * NxFi(2, a);
    ...
    VxNx(1, a) = VxFi(0, 1) * NxFi(0, a) + VxFi(1, 1) * NxFi(1, a) +
                 VxFi(2, 1) * NxFi(2, a);
    VxNx(2, a) = VxFi(0, 2) * NxFi(0, a) + VxFi(1, 2) * NxFi(1, a) +
                 VxFi(2, 2) * NxFi(2, a);
  }
  ...
  for (int b = 0; b < eNoNw; b++) {
    for (int a = 0; a < eNoNw; a++) {
      NxSNx = Nwx(0, a) * Siso(0, 0) * Nwx(0, b) +
              Nwx(0, a) * Siso(0, 1) * Nwx(1, b) +
              Nwx(0, a) * Siso(0, 2) * Nwx(2, b) +
              Nwx(1, a) * Siso(1, 0) * Nwx(0, b) +
              Nwx(1, a) * Siso(1, 1) * Nwx(1, b) +
              Nwx(1, a) * Siso(1, 2) * Nwx(2, b) +
              Nwx(2, a) * Siso(2, 0) * Nwx(0, b) +
              Nwx(2, a) * Siso(2, 1) * Nwx(1, b) +
              Nwx(2, a) * Siso(2, 2) * Nwx(2, b);
      ...
      T2 = af * Jac * tauC * rho * NxFi(0, a) * NxFi(1, b);
      Tv = af * mu * Jac *
           (NxFi(1, a) * NxFi(0, b) - r23 * NxFi(0, a) * NxFi(1, b));
      lK(1, a, b) = lK(1, a, b) + w * (T2 + Tv) + afm * Ku;
      ...
      Tv = af * mu * Jac *
           (NxFi(2, a) * NxFi(0, b) - r23 * NxFi(0, a) * NxFi(2, b));
      ...
      T2 = af * Jac * tauC * rho * NxFi(1, a) * NxFi(0, b);
      Tv = af * mu * Jac *
           (NxFi(0, a) * NxFi(1, b) - r23 * NxFi(1, a) * NxFi(0, b));
      ...
      Tv = af * mu * Jac *
           (NxFi(2, a) * NxFi(1, b) - r23 * NxFi(1, a) * NxFi(2, b));
      ...
      Tv = af * mu * Jac *
           (NxFi(0, a) * NxFi(2, b) - r23 * NxFi(2, a) * NxFi(0, b));
      ...
      Tv = af * mu * Jac *
           (NxFi(1, a) * NxFi(2, b) - r23 * NxFi(2, a) * NxFi(1, b));
      ...
      for (int a = 0; a < tnNo; a++) {
        ...
        for (int i = rowPtr(a); i <= rowPtr(a + 1) - 1; i++) {
          ...
          KU(0, a) = KU(0, a) + Kd(0, i) * Rd(0, c) + Kd(1, i) * Rd(1, c) +
                     Kd(2, i) * Rd(2, c);
          KU(1, a) = KU(1, a) + Kd(3, i) * Rd(0, c) + Kd(4, i) * Rd(1, c) +
                     Kd(5, i) * Rd(2, c);
          KU(2, a) = KU(2, a) + Kd(6, i) * Rd(0, c) + Kd(7, i) * Rd(1, c) +
                     Kd(8, i) * Rd(2, c);
          KU(3, a) = KU(3, a) + Kd(9, i) * Rd(0, c) + Kd(10, i) * Rd(1, c) +
                     Kd(11, i) * Rd(2, c);
        }
      }
