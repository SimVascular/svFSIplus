  ...
  for (int e = 0; e < lM.nEl; e++) {
    ...
    for (int g = 0; g < fs[0].nG; g++) {
      if (g == 0 || !fs[0].lShpF) {
        ...
        if (utils::is_zero(Jac)) {
          throw std::runtime_error("[construct_stokes] Jacobian for element " +
      ...
      if (nsd == 3) {
        ...
        stokes_3d_m(com_mod, fs[0].eNoN, fs[1].eNoN, w, N0, N1, Nwx, al, yl,
                    bfl, lR, lK);

      } else if (nsd == 2) {
        auto N0 = fs[0].N.col(g);
        auto N1 = fs[1].N.col(g);
        stokes_2d_m(com_mod, fs[0].eNoN, fs[1].eNoN, w, N0, N1, Nwx, al, yl,
                    bfl, lR, lK);
      }
    ...
    for (int g = 0; g < fs[1].nG; g++) {
      ...
      if (nsd == 3) {
        auto N0 = fs[0].N.col(g);
        auto N1 = fs[1].N.col(g);
        stokes_3d_c(com_mod, lStab, fs[0].eNoN, fs[1].eNoN, w, ksix, N0, N1,
                    Nwx, Nqx, al, yl, bfl, lR, lK);

      } else if (nsd == 2) {
        auto N0 = fs[0].N.col(g);
        auto N1 = fs[1].N.col(g);
        stokes_2d_c(com_mod, lStab, fs[0].eNoN, fs[1].eNoN, w, ksix, N0, N1,
                    Nwx, Nqx, al, yl, bfl, lR, lK);
      }
...
#define n_debug_stokes_2d_c
  ...
  for (int b = 0; b < eNoNw; b++) {
    for (int a = 0; a < eNoNq; a++) {
      lK(6, a, b) =
          lK(6, a, b) + wm * Nqx(0, a) * Nw(b) + wf * Nq(a) * Nwx(0, b);
      lK(7, a, b) =
          lK(7, a, b) + wm * Nqx(1, a) * Nw(b) + wf * Nq(a) * Nwx(1, b);
    }
  }
...
#define n_debug_stokes_2d_m
  ...
  for (int b = 0; b < eNoNw; b++) {
    for (int a = 0; a < eNoNw; a++) {
      ...
      lK(0, a, b) = lK(0, a, b) + wf * mu * (Nwx(0, a) * Nwx(0, b) + NxNx) +
                    wm * Nw(a) * Nw(b);
      lK(1, a, b) = lK(1, a, b) + wf * mu * (Nwx(1, a) * Nwx(0, b));
      lK(3, a, b) = lK(3, a, b) + wf * mu * (Nwx(0, a) * Nwx(1, b));
      lK(4, a, b) = lK(4, a, b) + wf * mu * (Nwx(1, a) * Nwx(1, b) + NxNx) +
                    wm * Nw(a) * Nw(b);
    }
  }
...
#define n_debug_stokes3d_c
  ...
  for (int b = 0; b < eNoNw; b++) {
    for (int a = 0; a < eNoNq; a++) {
      lK(13, a, b) =
          lK(13, a, b) + wm * Nqx(0, a) * Nw(b) + wf * Nq(a) * Nwx(0, b);
      lK(14, a, b) =
          lK(14, a, b) + wm * Nqx(1, a) * Nw(b) + wf * Nq(a) * Nwx(1, b);
      lK(15, a, b) =
          lK(15, a, b) + wm * Nqx(2, a) * Nw(b) + wf * Nq(a) * Nwx(2, b);
    }
  }
...
#define n_debug_stokes_3d_m
  ...
  for (int a = 0; a < eNoNw; a++) {
    ...
    rM = Nwx(0, a) * es(2, 0) + Nwx(1, a) * es(2, 1) +
         Nwx(2, a) * (-p + es(2, 2));
