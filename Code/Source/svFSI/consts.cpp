...
const std::map<ElementType, int> element_type_to_elem_nonb = {
    {ElementType::LIN1, 1}, {ElementType::LIN2, 1},  {ElementType::TRI3, 2},
    {ElementType::TRI6, 3}, {ElementType::QUD4, 2},  {ElementType::QUD8, 3},
    {ElementType::QUD9, 3}, {ElementType::TET4, 3},  {ElementType::TET10, 6},
    {ElementType::HEX8, 4}, {ElementType::HEX20, 8}, {ElementType::HEX27, 9},
    {ElementType::WDG, 3}};
...
//
const std::map<std::string, ConstitutiveModelType>
...
//
const std::map<std::string, FluidViscosityModelType>
...
static const std::map<int, ElementType> num_nodes_to_type = {
    {1, ElementType::PNT},    {2, ElementType::LIN1}, {2, ElementType::LIN2},
    {3, ElementType::TRI3},   {6, ElementType::TRI6}, {4, ElementType::QUD4},
    {8, ElementType::QUD8},   {9, ElementType::QUD9}, {4, ElementType::TET4},
    {10, ElementType::TET10}, {8, ElementType::HEX8}, {20, ElementType::HEX20},
    {27, ElementType::HEX27}, {6, ElementType::WDG},  {0, ElementType::NRB}};
...
const std::map<std::string, PreconditionerMapType> preconditioner_name_to_type =
    {{"fsils", std::make_pair(PreconditionerType::PREC_FSILS, false)},
     ...
     {"row-column-scaling",
      std::make_pair(PreconditionerType::PREC_RCS, false)},

     {"trilinos-diagonal",
      std::make_pair(PreconditionerType::PREC_TRILINOS_DIAGONAL, true)},

     {"trilinos-blockjacobi",
      std::make_pair(PreconditionerType::PREC_TRILINOS_BLOCK_JACOBI, true)},
     {"blockjacobi",
      std::make_pair(PreconditionerType::PREC_TRILINOS_BLOCK_JACOBI, true)},

     {"trilinos-ilu",
      std::make_pair(PreconditionerType::PREC_TRILINOS_ILU, true)},
     {"trilinos-ilut",
      std::make_pair(PreconditionerType::PREC_TRILINOS_ILUT, true)},

     {"trilinos-ic",
      std::make_pair(PreconditionerType::PREC_TRILINOS_IC, true)},
     {"trilinos-ict",
      std::make_pair(PreconditionerType::PREC_TRILINOS_ICT, true)},
