...
#define n_debug_l_elas_2d
  ...
  for (int a = 0; a < eNoN; a++) {
    lR(0, a) =
        lR(0, a) + w * (rho * N(a) * ud(0) + Nx(0, a) * S(0) + Nx(1, a) * S(2));
    lR(1, a) =
        lR(1, a) + w * (rho * N(a) * ud(1) + Nx(0, a) * S(2) + Nx(1, a) * S(1));
    ...
    for (int b = 0; b < eNoN; b++) {
      ...
      lK(1, a, b) =
          lK(1, a, b) + wl * (lDm * Nx(0, a) * Nx(1, b) + Nx(1, a) * Nx(0, b));

      lK(dof + 0, a, b) = lK(dof + 0, a, b) + wl * (lDm * Nx(1, a) * Nx(0, b) +
                                                    Nx(0, a) * Nx(1, b));
      lK(dof + 1, a, b) =
          lK(dof + 1, a, b) + wl * (T1 + (1.0 + lDm) * Nx(1, a) * Nx(1, b));
    }
  }
}
...
#define n_debug_l_elas_3d
  ...
  for (int a = 0; a < eNoN; a++) {
    lR(0, a) = lR(0, a) + w * (rho * N(a) * ud(0) + Nx(0, a) * S(0) +
                               Nx(1, a) * S(3) + Nx(2, a) * S(5));
    lR(1, a) = lR(1, a) + w * (rho * N(a) * ud(1) + Nx(0, a) * S(3) +
                               Nx(1, a) * S(1) + Nx(2, a) * S(4));
    lR(2, a) = lR(2, a) + w * (rho * N(a) * ud(2) + Nx(0, a) * S(5) +
                               Nx(1, a) * S(4) + Nx(2, a) * S(2));
    ...
    for (int b = 0; b < eNoN; b++) {
      ...
      lK(1, a, b) =
          lK(1, a, b) + wl * (lDm * Nx(0, a) * Nx(1, b) + Nx(1, a) * Nx(0, b));
      lK(2, a, b) =
          lK(2, a, b) + wl * (lDm * Nx(0, a) * Nx(2, b) + Nx(2, a) * Nx(0, b));

      lK(dof + 0, a, b) = lK(dof + 0, a, b) + wl * (lDm * Nx(1, a) * Nx(0, b) +
                                                    Nx(0, a) * Nx(1, b));
      lK(dof + 1, a, b) =
          lK(dof + 1, a, b) + wl * (T1 + (1.0 + lDm) * Nx(1, a) * Nx(1, b));
      lK(dof + 2, a, b) = lK(dof + 2, a, b) + wl * (lDm * Nx(1, a) * Nx(2, b) +
                                                    Nx(2, a) * Nx(1, b));

      lK(2 * dof + 0, a, b) =
          lK(2 * dof + 0, a, b) +
          wl * (lDm * Nx(2, a) * Nx(0, b) + Nx(0, a) * Nx(2, b));
      lK(2 * dof + 1, a, b) =
          lK(2 * dof + 1, a, b) +
          wl * (lDm * Nx(2, a) * Nx(1, b) + Nx(1, a) * Nx(2, b));
      lK(2 * dof + 2, a, b) =
          lK(2 * dof + 2, a, b) + wl * (T1 + (1.0 + lDm) * Nx(2, a) * Nx(2, b));
    }
  }
}
