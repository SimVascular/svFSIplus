              ...
              double C[N][N][N][N])
{
  ...
  if (N == 2) {
    for (int ii = 0; ii < nn; ii++) {
      ...
      C[i][j][k][l] +=
          A[i][j][0][0] * B[k][l][0][0] + A[i][j][0][1] * B[k][l][0][1] +
    ...
    for (int ii = 0; ii < nn; ii++) {
      ...
      C[i][j][k][l] +=
          A[i][j][0][0] * B[k][l][0][0] + A[i][j][0][1] * B[k][l][0][1] +
          A[i][j][0][2] * B[k][l][0][2] + A[i][j][1][0] * B[k][l][1][0] +
          A[i][j][1][1] * B[k][l][1][1] + A[i][j][1][2] * B[k][l][1][2] +
          A[i][j][2][0] * B[k][l][2][0] + A[i][j][2][1] * B[k][l][2][1] +
          A[i][j][2][2] * B[k][l][2][2];
    }
  }
}
