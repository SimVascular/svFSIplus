...
using SeMaterialPropertiesMapType = std::map<
    consts::ConstitutiveModelType,
...
SeMaterialPropertiesMapType set_material_props = {
    ...
    //---------------------------//
    //
    {consts::ConstitutiveModelType::stIso_nHook,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
    ...
    //---------------------------//
    //
    {consts::ConstitutiveModelType::stIso_lin,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
    ...
    //---------------------------//
    //
    {consts::ConstitutiveModelType::stIso_StVK,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
    ...
    //---------------------------//
    //
    {consts::ConstitutiveModelType::stIso_mStVK,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
    ...
    //---------------------------//
    //
    {consts::ConstitutiveModelType::stIso_MR,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
       lDmn.stM.isoType = consts::ConstitutiveModelType::stIso_MR;
       lDmn.stM.C10 =
           domain_params->constitutive_model.mooney_rivlin.c1.value();
       lDmn.stM.C01 = lDmn.stM.C10 =
           domain_params->constitutive_model.mooney_rivlin.c2.value();
     }},
    ...
    //---------------------------//
    //
    {consts::ConstitutiveModelType::stIso_HGO,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
    ...
    //---------------------------//
    //
    {consts::ConstitutiveModelType::stIso_Gucci,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
    ...
    //---------------------------//
    //
    {consts::ConstitutiveModelType::stIso_HO,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
    ...
    //
    {consts::ConstitutiveModelType::stIso_LS,
     [](DomainParameters* domain_params, double mu, double kap, double lam,
        dmnType& lDmn) -> void {
