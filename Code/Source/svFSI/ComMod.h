...
// The classes defined here duplicate the data structures in the Fortran COMMOD
// module defined in MOD.f.
//
// All of the data structures used for the mesh, boundarsy conditions and solver
// parameters, etc. are defined here.
...
class stModelType
{
  public:
    ...
    consts::ConstitutiveModelType volType =
        consts::ConstitutiveModelType::stIso_NA;

    // Penalty parameter
    double Kpen = 0.0;

    // Type of constitutive model (isochoric) for struct/FSI
    consts::ConstitutiveModelType isoType =
        consts::ConstitutiveModelType::stIso_NA;
...
class viscModelType
{
  public:
    ...
    consts::FluidViscosityModelType viscType =
        consts::FluidViscosityModelType::viscType_NA;
...
class mshType
{
  public:
    ...
    */
    ...
    ~mshType(){
        // std::cout << "- - - - -  mshType dtor - - - - -   dname: " << dname
        // <<
        // std::endl;
    };
...
/// @brief The ComMod class duplicates the data structures in the Fortran COMMOD
/// module defined in MOD.f.
///
...
class ComMod
{
  public:
    ...
    /// @brief Whether velocity-pressure based structural dynamics solver is
    /// used
    bool sstEq = false;
