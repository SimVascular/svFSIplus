...
void b_struct_2d(const ComMod& com_mod, const int eNoN, const double w,
...
void b_struct_3d(const ComMod& com_mod, const int eNoN, const double w,
                 const Vector<double>& N, const Array<double>& Nx,
                 const Array<double>& dl, const Vector<double>& hl,
                 const Vector<double>& nV, Array<double>& lR,
                 Array3<double>& lK) {
#define n_debug_b_struct_3d
  ...
  for (int a = 0; a < eNoN; a++) {
    ...
    NxFi(2, a) =
        Nx(0, a) * Fi(0, 2) + Nx(1, a) * Fi(1, 2) + Nx(2, a) * Fi(2, 2);
  }
...
#define n_debug_struct_2d
  ...
  for (int a = 0; a < eNoN; a++) {
    lR(0, a) =
        lR(0, a) + w * (N(a) * ud(0) + Nx(0, a) * P(0, 0) + Nx(2, a) * P(0, 1));
    lR(1, a) =
        lR(1, a) + w * (N(a) * ud(1) + Nx(0, a) * P(1, 0) + Nx(1, a) * P(1, 1));
  }
    ...
    for (int a = 0; a < eNoN; a++) {
      ...
      Tv = (2.0 * (DdNx(0, a) * NxFi(1, b) - DdNx(0, b) * NxFi(1, a)) -
            (NxNx * VxFi(0, 1) + NxFi(0, b) * VxNx(1, a) -
             NxFi(0, a) * VxNx(1, b))) *
               rmu +
           (NxFi(1, a) * NxFi(0, b) - NxFi(0, a) * NxFi(1, b)) * rmv;
      ...
      Tv = (2.0 * (DdNx(1, a) * NxFi(0, b) - DdNx(1, b) * NxFi(0, a)) -
            (NxNx * VxFi(1, 0) + NxFi(1, b) * VxNx(0, a) -
             NxFi(1, a) * VxNx(0, b))) *
               rmu +
           (NxFi(0, a) * NxFi(1, b) - NxFi(1, a) * NxFi(0, b)) * rmv;
...
#define n_debug_struct_3d
  ...
  // Local residual
  for (int a = 0; a < eNoN; a++) {
    lR(0, a) = lR(0, a) + w * (N(a) * ud(0) + Nx(0, a) * P(0, 0) +
                               Nx(1, a) * P(0, 1) + Nx(2, a) * P(0, 2));
    lR(1, a) = lR(1, a) + w * (N(a) * ud(1) + Nx(0, a) * P(1, 0) +
                               Nx(1, a) * P(1, 1) + Nx(2, a) * P(1, 2));
    lR(2, a) = lR(2, a) + w * (N(a) * ud(2) + Nx(0, a) * P(2, 0) +
                               Nx(1, a) * P(2, 1) + Nx(2, a) * P(2, 2));
  }
  ...
  for (int b = 0; b < eNoN; b++) {
    for (int a = 0; a < eNoN; a++) {
      ...
      Tv = (2.0 * (DdNx(0, a) * NxFi(0, b) - DdNx(0, b) * NxFi(0, a)) -
            (NxNx * VxFi(0, 0) + NxFi(0, b) * VxNx(0, a) -
             r23 * NxFi(0, a) * VxNx(0, b))) *
               rmu +
           (r13 * NxFi(0, a) * NxFi(0, b) + NxNx) * rmv;
      ...
      Tv = (2.0 * (DdNx(1, a) * NxFi(2, b) - DdNx(1, b) * NxFi(2, a)) -
            (NxNx * VxFi(1, 2) + NxFi(1, b) * VxNx(2, a) -
             r23 * NxFi(1, a) * VxNx(2, b))) *
               rmu +
           (NxFi(2, a) * NxFi(1, b) - r23 * NxFi(1, a) * NxFi(2, b)) * rmv;
      ...
      Tv = (2.0 * (DdNx(2, a) * NxFi(0, b) - DdNx(2, b) * NxFi(0, a)) -
            (NxNx * VxFi(2, 0) + NxFi(2, b) * VxNx(0, a) -
             r23 * NxFi(2, a) * VxNx(0, b))) *
               rmu +
           (NxFi(0, a) * NxFi(2, b) - r23 * NxFi(2, a) * NxFi(0, b)) * rmv;
      ...
      Tv = (2.0 * (DdNx(2, a) * NxFi(1, b) - DdNx(2, b) * NxFi(1, a)) -
            (NxNx * VxFi(2, 1) + NxFi(2, b) * VxNx(1, a) -
             r23 * NxFi(2, a) * VxNx(1, b))) *
               rmu +
           (NxFi(1, a) * NxFi(2, b) - r23 * NxFi(2, a) * NxFi(1, b)) * rmv;
      ...
      lK(2 * dof + 2, a, b) =
          lK(2 * dof + 2, a, b) + w * (T1 + afu * BmDBm + Tv);
    }
  }
}
