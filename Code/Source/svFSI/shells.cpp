  ...
  */
  ...
  for (int a = 0; a < eNoN; a++) {
    for (int i = 0; i < 3; i++) {
      for (int j = 0; j < 3; j++) {
        Bb(i, j, a) =
            Bb(i, j, a) + Nx(0, a) * KNmMm(i, j, 1) - Nx(1, a) * KNmMm(i, j, 0);
      }
    }
  }
  ...
  //
  Array3<double> D0Bm(3, 3, eNoN), D1Bm(3, 3, eNoN), D1Bb(3, 3, eNoN),
      D2Bb(3, 3, eNoN);
  ...
  for (int a = 0; a < eNoN; a++) {
    double BmS = Bm(0, 0, a) * Sm(0, 0) + Bm(1, 0, a) * Sm(1, 0) +
                 Bm(2, 0, a) * Sm(2, 0);
    double BbS = Bb(0, 0, a) * Sm(0, 1) + Bb(1, 0, a) * Sm(1, 1) +
                 Bb(2, 0, a) * Sm(2, 1);
    lR(0, a) = lR(0, a) + wh * N(a) * ud(0) + w * (BmS + BbS);

    BmS = Bm(0, 1, a) * Sm(0, 0) + Bm(1, 1, a) * Sm(1, 0) +
          Bm(2, 1, a) * Sm(2, 0);
    BbS = Bb(0, 1, a) * Sm(0, 1) + Bb(1, 1, a) * Sm(1, 1) +
          Bb(2, 1, a) * Sm(2, 1);
    lR(1, a) = lR(1, a) + wh * N(a) * ud(1) + w * (BmS + BbS);

    BmS = Bm(0, 2, a) * Sm(0, 0) + Bm(1, 2, a) * Sm(1, 0) +
          Bm(2, 2, a) * Sm(2, 0);
    BbS = Bb(0, 2, a) * Sm(0, 1) + Bb(1, 2, a) * Sm(1, 1) +
          Bb(2, 2, a) * Sm(2, 1);
  ...
  for (int b = 0; b < eNoN; b++) {
    for (int a = 0; a < eNoN; a++) {
      ...
      double NxSNx =
          Nx(0, a) * Nx(0, b) * Sm(0, 0) + Nx(1, a) * Nx(1, b) * Sm(1, 0) +
      ...
      double BmDBm = Bm(0, 0, a) * D0Bm(0, 0, b) + Bm(1, 0, a) * D0Bm(1, 0, b) +
                     Bm(2, 0, a) * D0Bm(2, 0, b);
      double BmDBb = Bm(0, 0, a) * D1Bb(0, 0, b) + Bm(1, 0, a) * D1Bb(1, 0, b) +
                     Bm(2, 0, a) * D1Bb(2, 0, b);
      double BbDBm = Bb(0, 0, a) * D1Bm(0, 0, b) + Bb(1, 0, a) * D1Bm(1, 0, b) +
                     Bb(2, 0, a) * D1Bm(2, 0, b);
      double BbDBb = Bb(0, 0, a) * D2Bb(0, 0, b) + Bb(1, 0, a) * D2Bb(1, 0, b) +
                     Bb(2, 0, a) * D2Bb(2, 0, b);
      lK(0, a, b) = lK(0, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);

      BmDBm = Bm(0, 0, a) * D0Bm(0, 1, b) + Bm(1, 0, a) * D0Bm(1, 1, b) +
              Bm(2, 0, a) * D0Bm(2, 1, b);
      BmDBb = Bm(0, 0, a) * D1Bb(0, 1, b) + Bm(1, 0, a) * D1Bb(1, 1, b) +
              Bm(2, 0, a) * D1Bb(2, 1, b);
      BbDBm = Bb(0, 0, a) * D1Bm(0, 1, b) + Bb(1, 0, a) * D1Bm(1, 1, b) +
              Bb(2, 0, a) * D1Bm(2, 1, b);
      BbDBb = Bb(0, 0, a) * D2Bb(0, 1, b) + Bb(1, 0, a) * D2Bb(1, 1, b) +
              Bb(2, 0, a) * D2Bb(2, 1, b);
      lK(1, a, b) = lK(1, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);

      BmDBm = Bm(0, 0, a) * D0Bm(0, 2, b) + Bm(1, 0, a) * D0Bm(1, 2, b) +
              Bm(2, 0, a) * D0Bm(2, 2, b);
      BmDBb = Bm(0, 0, a) * D1Bb(0, 2, b) + Bm(1, 0, a) * D1Bb(1, 2, b) +
              Bm(2, 0, a) * D1Bb(2, 2, b);
      BbDBm = Bb(0, 0, a) * D1Bm(0, 2, b) + Bb(1, 0, a) * D1Bm(1, 2, b) +
              Bb(2, 0, a) * D1Bm(2, 2, b);
      BbDBb = Bb(0, 0, a) * D2Bb(0, 2, b) + Bb(1, 0, a) * D2Bb(1, 2, b) +
              Bb(2, 0, a) * D2Bb(2, 2, b);
      lK(2, a, b) = lK(2, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);

      BmDBm = Bm(0, 1, a) * D0Bm(0, 0, b) + Bm(1, 1, a) * D0Bm(1, 0, b) +
              Bm(2, 1, a) * D0Bm(2, 0, b);
      BmDBb = Bm(0, 1, a) * D1Bb(0, 0, b) + Bm(1, 1, a) * D1Bb(1, 0, b) +
              Bm(2, 1, a) * D1Bb(2, 0, b);
      BbDBm = Bb(0, 1, a) * D1Bm(0, 0, b) + Bb(1, 1, a) * D1Bm(1, 0, b) +
              Bb(2, 1, a) * D1Bm(2, 0, b);
      BbDBb = Bb(0, 1, a) * D2Bb(0, 0, b) + Bb(1, 1, a) * D2Bb(1, 0, b) +
              Bb(2, 1, a) * D2Bb(2, 0, b);
      lK(dof + 0, a, b) =
          lK(dof + 0, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);

      BmDBm = Bm(0, 1, a) * D0Bm(0, 1, b) + Bm(1, 1, a) * D0Bm(1, 1, b) +
              Bm(2, 1, a) * D0Bm(2, 1, b);
      BbDBm = Bb(0, 1, a) * D1Bm(0, 1, b) + Bb(1, 1, a) * D1Bm(1, 1, b) +
              Bb(2, 1, a) * D1Bm(2, 1, b);
      BbDBb = Bb(0, 1, a) * D2Bb(0, 1, b) + Bb(1, 1, a) * D2Bb(1, 1, b) +
              Bb(2, 1, a) * D2Bb(2, 1, b);
      lK(dof + 1, a, b) =
          lK(dof + 1, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);

      BmDBm = Bm(0, 1, a) * D0Bm(0, 2, b) + Bm(1, 1, a) * D0Bm(1, 2, b) +
              Bm(2, 1, a) * D0Bm(2, 2, b);
      BmDBb = Bm(0, 1, a) * D1Bb(0, 2, b) + Bm(1, 1, a) * D1Bb(1, 2, b) +
              Bm(2, 1, a) * D1Bb(2, 2, b);
      BbDBm = Bb(0, 1, a) * D1Bm(0, 2, b) + Bb(1, 1, a) * D1Bm(1, 2, b) +
              Bb(2, 1, a) * D1Bm(2, 2, b);
      BbDBb = Bb(0, 1, a) * D2Bb(0, 2, b) + Bb(1, 1, a) * D2Bb(1, 2, b) +
              Bb(2, 1, a) * D2Bb(2, 2, b);
      lK(dof + 2, a, b) =
          lK(dof + 2, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);

      BmDBm = Bm(0, 2, a) * D0Bm(0, 0, b) + Bm(1, 2, a) * D0Bm(1, 0, b) +
              Bm(2, 2, a) * D0Bm(2, 0, b);
      BmDBb = Bm(0, 2, a) * D1Bb(0, 0, b) + Bm(1, 2, a) * D1Bb(1, 0, b) +
              Bm(2, 2, a) * D1Bb(2, 0, b);
      BbDBm = Bb(0, 2, a) * D1Bm(0, 0, b) + Bb(1, 2, a) * D1Bm(1, 0, b) +
              Bb(2, 2, a) * D1Bm(2, 0, b);
      BbDBb = Bb(0, 2, a) * D2Bb(0, 0, b) + Bb(1, 2, a) * D2Bb(1, 0, b) +
              Bb(2, 2, a) * D2Bb(2, 0, b);
      lK(2 * dof + 0, a, b) =
          lK(2 * dof + 0, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);

      BmDBm = Bm(0, 2, a) * D0Bm(0, 1, b) + Bm(1, 2, a) * D0Bm(1, 1, b) +
              Bm(2, 2, a) * D0Bm(2, 1, b);
      BmDBb = Bm(0, 2, a) * D1Bb(0, 1, b) + Bm(1, 2, a) * D1Bb(1, 1, b) +
              Bm(2, 2, a) * D1Bb(2, 1, b);
      BbDBm = Bb(0, 2, a) * D1Bm(0, 1, b) + Bb(1, 2, a) * D1Bm(1, 1, b) +
              Bb(2, 2, a) * D1Bm(2, 1, b);
      BbDBb = Bb(0, 2, a) * D2Bb(0, 1, b) + Bb(1, 2, a) * D2Bb(1, 1, b) +
              Bb(2, 2, a) * D2Bb(2, 1, b);
      lK(2 * dof + 1, a, b) =
          lK(2 * dof + 1, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);

      BmDBm = Bm(0, 2, a) * D0Bm(0, 2, b) + Bm(1, 2, a) * D0Bm(1, 2, b) +
              Bm(2, 2, a) * D0Bm(2, 2, b);
      BmDBb = Bm(0, 2, a) * D1Bb(0, 2, b) + Bm(1, 2, a) * D1Bb(1, 2, b) +
              Bm(2, 2, a) * D1Bb(2, 2, b);
      BbDBm = Bb(0, 2, a) * D1Bm(0, 2, b) + Bb(1, 2, a) * D1Bm(1, 2, b) +
              Bb(2, 2, a) * D1Bm(2, 2, b);
      BbDBb = Bb(0, 2, a) * D2Bb(0, 2, b) + Bb(1, 2, a) * D2Bb(1, 2, b) +
              Bb(2, 2, a) * D2Bb(2, 2, b);
      lK(2 * dof + 2, a, b) =
          lK(2 * dof + 2, a, b) + afl * (BmDBm + BmDBb + BbDBm + BbDBb);
    }
  }
}
...
#define n_debug_shell_bend_cst
  ...
  if (bFlag) {
    for (int j = lM.eNoN; j < eNoN; j++) {
      ...
      x0(0, j) = 2.0 * (nInI(0, 0) * a0(0, p) + nInI(0, 1) * a0(1, p) +
                        nInI(0, 2) * a0(2, p)) +
                 x0(0, i);
      x0(1, j) = 2.0 * (nInI(1, 0) * a0(0, p) + nInI(1, 1) * a0(1, p) +
                        nInI(1, 2) * a0(2, p)) +
                 x0(1, i);
      x0(2, j) = 2.0 * (nInI(2, 0) * a0(0, p) + nInI(2, 1) * a0(1, p) +
                        nInI(2, 2) * a0(2, p)) +
                 x0(2, i);
      ...
      xc(0, j) = 2.0 * (nInI(0, 0) * a(0, p) + nInI(0, 1) * a(1, p) +
                        nInI(0, 2) * a(2, p)) +
                 xc(0, i);
      xc(1, j) = 2.0 * (nInI(1, 0) * a(0, p) + nInI(1, 1) * a(1, p) +
                        nInI(1, 2) * a(2, p)) +
                 xc(1, i);
      xc(2, j) = 2.0 * (nInI(2, 0) * a(0, p) + nInI(2, 1) * a(1, p) +
                        nInI(2, 2) * a(2, p)) +
                 xc(2, i);

      if (utils::btest(lM.sbc(i, e),
                       enum_int(BoundaryConditionType::bType_fix))) {
        for (int i = 0; i < 3; i++) {
          xc(i, j) = x0(i, j);
        }
      }
  ...
  if (bFlag) {
    ...
    for (int j = lM.eNoN; j < eNoN; j++) {
      ...
      //
      if (utils::btest(lM.sbc(i, e),
                       enum_int(BoundaryConditionType::bType_free))) {
        // E_I
        //
        if (!lFix[i]) {
          tmpA = -Im + 2.0 * eIeI;
      ...
      } else if (utils::btest(lM.sbc(i, e),
                              enum_int(BoundaryConditionType::bType_hing))) {
        // E_I
        if (!lFix[i]) {
          tmpA = -Im + 2.0 * eIeI;
          Bb.rslice(i) = Bb.rslice(i) + mat_mul(Bb.rslice(j), tmpA);
        ...
        //
                              ...
                              enum_int(BoundaryConditionType::bType_symm))) {
        if (!lFix[i]) {
          tmpA = Im - 2.0 * nInI;
          Bb.rslice(i) = Bb.rslice(i) + mat_mul(Bb.rslice(j), tmpA);
        }
              ...
              const Array<double>& tfl, Array<double>& lR, Array3<double>& lK)
{
  ...
  double tfn = 0.0;
  Array<double> xc(3, eNoN);
  // [NOTE] This is a hack for enabling 'tfl' to be used as a vector in the
  // Fortran.
...
//
void shell_cst(ComMod& com_mod, const mshType& lM, const int e, const int eNoN,
               const int nFn, const Array<double>& fN, const Array<double>& al,
               const Array<double>& yl, const Array<double>& dl,
               const Array<double>& xl, const Array<double>& bfl,
...
#define n_debug_shell_cst
  ...
  */
  ...
  for (int a = 0; a < lM.eNoN; a++) {
    double BtS = Bm(0, 0, a) * Sm(0, 0) + Bm(1, 0, a) * Sm(1, 0) +
                 Bm(2, 0, a) * Sm(2, 0);
    lR(0, a) = lR(0, a) + w * BtS;

    BtS = Bm(0, 1, a) * Sm(0, 0) + Bm(1, 1, a) * Sm(1, 0) +
          Bm(2, 1, a) * Sm(2, 0);
    lR(1, a) = lR(1, a) + w * BtS;

    BtS = Bm(0, 2, a) * Sm(0, 0) + Bm(1, 2, a) * Sm(1, 0) +
          Bm(2, 2, a) * Sm(2, 0);
    lR(2, a) = lR(2, a) + w * BtS;
  }
  ...
  //
  for (int a = 0; a < eNoN; a++) {
    double BtS = Bb(0, 0, a) * Sm(0, 1) + Bb(1, 0, a) * Sm(1, 1) +
                 Bb(2, 0, a) * Sm(2, 1);
    lR(0, a) = lR(0, a) + w * BtS;

    BtS = Bb(0, 1, a) * Sm(0, 1) + Bb(1, 1, a) * Sm(1, 1) +
          Bb(2, 1, a) * Sm(2, 1);
    lR(1, a) = lR(1, a) + w * BtS;

    BtS = Bb(0, 2, a) * Sm(0, 1) + Bb(1, 2, a) * Sm(1, 1) +
          Bb(2, 2, a) * Sm(2, 1);
    lR(2, a) = lR(2, a) + w * BtS;
  }
  ...
  for (int b = 0; b < lM.eNoN; b++) {
    for (int a = 0; a < lM.eNoN; a++) {
      ...
      double BtDB = Bm(0, 0, a) * D0Bm(0, 0, b) + Bm(1, 0, a) * D0Bm(1, 0, b) +
                    Bm(2, 0, a) * D0Bm(2, 0, b);
      lK(0, a, b) = lK(0, a, b) + w * (BtDB + NxSNx);

      BtDB = Bm(0, 0, a) * D0Bm(0, 1, b) + Bm(1, 0, a) * D0Bm(1, 1, b) +
             Bm(2, 0, a) * D0Bm(2, 1, b);
      lK(1, a, b) = lK(1, a, b) + w * BtDB;

      BtDB = Bm(0, 0, a) * D0Bm(0, 2, b) + Bm(1, 0, a) * D0Bm(1, 2, b) +
             Bm(2, 0, a) * D0Bm(2, 2, b);
      lK(2, a, b) = lK(2, a, b) + w * BtDB;

      BtDB = Bm(0, 1, a) * D0Bm(0, 0, b) + Bm(1, 1, a) * D0Bm(1, 0, b) +
             Bm(2, 1, a) * D0Bm(2, 0, b);
      lK(dof + 0, a, b) = lK(dof + 0, a, b) + w * BtDB;

      BtDB = Bm(0, 1, a) * D0Bm(0, 1, b) + Bm(1, 1, a) * D0Bm(1, 1, b) +
             Bm(2, 1, a) * D0Bm(2, 1, b);
      lK(dof + 1, a, b) = lK(dof + 1, a, b) + w * (BtDB + NxSNx);

      BtDB = Bm(0, 1, a) * D0Bm(0, 2, b) + Bm(1, 1, a) * D0Bm(1, 2, b) +
             Bm(2, 1, a) * D0Bm(2, 2, b);
      lK(dof + 2, a, b) = lK(dof + 2, a, b) + w * BtDB;

      BtDB = Bm(0, 2, a) * D0Bm(0, 0, b) + Bm(1, 2, a) * D0Bm(1, 0, b) +
             Bm(2, 2, a) * D0Bm(2, 0, b);
      lK(2 * dof + 0, a, b) = lK(2 * dof + 0, a, b) + w * BtDB;

      BtDB = Bm(0, 2, a) * D0Bm(0, 1, b) + Bm(1, 2, a) * D0Bm(1, 1, b) +
             Bm(2, 2, a) * D0Bm(2, 1, b);
      lK(2 * dof + 1, a, b) = lK(2 * dof + 1, a, b) + w * BtDB;

      BtDB = Bm(0, 2, a) * D0Bm(0, 2, b) + Bm(1, 2, a) * D0Bm(1, 2, b) +
             Bm(2, 2, a) * D0Bm(2, 2, b);
  ...
  for (int b = 0; b < eNoN; b++) {
    for (int a = 0; a < lM.eNoN; a++) {
      double BtDB = Bm(0, 0, a) * D1Bb(0, 0, b) + Bm(1, 0, a) * D1Bb(1, 0, b) +
                    Bm(2, 0, a) * D1Bb(2, 0, b);
      lK(0, a, b) = lK(0, a, b) + w * BtDB;

      BtDB = Bm(0, 0, a) * D1Bb(0, 1, b) + Bm(1, 0, a) * D1Bb(1, 1, b) +
             Bm(2, 0, a) * D1Bb(2, 1, b);
      lK(1, a, b) = lK(1, a, b) + w * BtDB;

      BtDB = Bm(0, 0, a) * D1Bb(0, 2, b) + Bm(1, 0, a) * D1Bb(1, 2, b) +
             Bm(2, 0, a) * D1Bb(2, 2, b);
      lK(2, a, b) = lK(2, a, b) + w * BtDB;

      BtDB = Bm(0, 1, a) * D1Bb(0, 0, b) + Bm(1, 1, a) * D1Bb(1, 0, b) +
             Bm(2, 1, a) * D1Bb(2, 0, b);
      lK(dof + 0, a, b) = lK(dof + 0, a, b) + w * BtDB;

      BtDB = Bm(0, 1, a) * D1Bb(0, 1, b) + Bm(1, 1, a) * D1Bb(1, 1, b) +
             Bm(2, 1, a) * D1Bb(2, 1, b);
      lK(dof + 1, a, b) = lK(dof + 1, a, b) + w * BtDB;

      BtDB = Bm(0, 1, a) * D1Bb(0, 2, b) + Bm(1, 1, a) * D1Bb(1, 2, b) +
             Bm(2, 1, a) * D1Bb(2, 2, b);
      lK(dof + 2, a, b) = lK(dof + 2, a, b) + w * BtDB;

      BtDB = Bm(0, 2, a) * D1Bb(0, 0, b) + Bm(1, 2, a) * D1Bb(1, 0, b) +
             Bm(2, 2, a) * D1Bb(2, 0, b);
      lK(2 * dof + 0, a, b) = lK(2 * dof + 0, a, b) + w * BtDB;

      BtDB = Bm(0, 2, a) * D1Bb(0, 1, b) + Bm(1, 2, a) * D1Bb(1, 1, b) +
             Bm(2, 2, a) * D1Bb(2, 1, b);
      lK(2 * dof + 1, a, b) = lK(2 * dof + 1, a, b) + w * BtDB;

      BtDB = Bm(0, 2, a) * D1Bb(0, 2, b) + Bm(1, 2, a) * D1Bb(1, 2, b) +
             Bm(2, 2, a) * D1Bb(2, 2, b);
  ...
  for (int b = 0; b < lM.eNoN; b++) {
    for (int a = 0; a < eNoN; a++) {
      double BtDB = Bb(0, 0, a) * D1Bm(0, 0, b) + Bb(1, 0, a) * D1Bm(1, 0, b) +
                    Bb(2, 0, a) * D1Bm(2, 0, b);
      lK(0, a, b) = lK(0, a, b) + w * BtDB;

      BtDB = Bb(0, 0, a) * D1Bm(0, 1, b) + Bb(1, 0, a) * D1Bm(1, 1, b) +
             Bb(2, 0, a) * D1Bm(2, 1, b);
      lK(1, a, b) = lK(1, a, b) + w * BtDB;

      BtDB = Bb(0, 0, a) * D1Bm(0, 2, b) + Bb(1, 0, a) * D1Bm(1, 2, b) +
             Bb(2, 0, a) * D1Bm(2, 2, b);
      lK(2, a, b) = lK(2, a, b) + w * BtDB;

      BtDB = Bb(0, 1, a) * D1Bm(0, 0, b) + Bb(1, 1, a) * D1Bm(1, 0, b) +
             Bb(2, 1, a) * D1Bm(2, 0, b);
      lK(dof + 0, a, b) = lK(dof + 0, a, b) + w * BtDB;

      BtDB = Bb(0, 1, a) * D1Bm(0, 1, b) + Bb(1, 1, a) * D1Bm(1, 1, b) +
             Bb(2, 1, a) * D1Bm(2, 1, b);
      lK(dof + 1, a, b) = lK(dof + 1, a, b) + w * BtDB;

      BtDB = Bb(0, 1, a) * D1Bm(0, 2, b) + Bb(1, 1, a) * D1Bm(1, 2, b) +
             Bb(2, 1, a) * D1Bm(2, 2, b);
      lK(dof + 2, a, b) = lK(dof + 2, a, b) + w * BtDB;

      BtDB = Bb(0, 2, a) * D1Bm(0, 0, b) + Bb(1, 2, a) * D1Bm(1, 0, b) +
             Bb(2, 2, a) * D1Bm(2, 0, b);
      lK(2 * dof + 0, a, b) = lK(2 * dof + 0, a, b) + w * BtDB;

      BtDB = Bb(0, 2, a) * D1Bm(0, 1, b) + Bb(1, 2, a) * D1Bm(1, 1, b) +
             Bb(2, 2, a) * D1Bm(2, 1, b);
      lK(2 * dof + 1, a, b) = lK(2 * dof + 1, a, b) + w * BtDB;

      BtDB = Bb(0, 2, a) * D1Bm(0, 2, b) + Bb(1, 2, a) * D1Bm(1, 2, b) +
             Bb(2, 2, a) * D1Bm(2, 2, b);
      lK(2 * dof + 2, a, b) = lK(2 * dof + 2, a, b) + w * BtDB;
    }
  }
  ...
  for (int b = 0; b < eNoN; b++) {
    for (int a = 0; a < eNoN; a++) {
      double BtDB = Bb(0, 0, a) * D2Bb(0, 0, b) + Bb(1, 0, a) * D2Bb(1, 0, b) +
                    Bb(2, 0, a) * D2Bb(2, 0, b);
      lK(0, a, b) = lK(0, a, b) + w * BtDB;

      BtDB = Bb(0, 0, a) * D2Bb(0, 1, b) + Bb(1, 0, a) * D2Bb(1, 1, b) +
             Bb(2, 0, a) * D2Bb(2, 1, b);
      lK(1, a, b) = lK(1, a, b) + w * BtDB;

      BtDB = Bb(0, 0, a) * D2Bb(0, 2, b) + Bb(1, 0, a) * D2Bb(1, 2, b) +
             Bb(2, 0, a) * D2Bb(2, 2, b);
      lK(2, a, b) = lK(2, a, b) + w * BtDB;

      BtDB = Bb(0, 1, a) * D2Bb(0, 0, b) + Bb(1, 1, a) * D2Bb(1, 0, b) +
             Bb(2, 1, a) * D2Bb(2, 0, b);
      lK(dof + 0, a, b) = lK(dof + 0, a, b) + w * BtDB;

      BtDB = Bb(0, 1, a) * D2Bb(0, 1, b) + Bb(1, 1, a) * D2Bb(1, 1, b) +
             Bb(2, 1, a) * D2Bb(2, 1, b);
      lK(dof + 1, a, b) = lK(dof + 1, a, b) + w * BtDB;

      BtDB = Bb(0, 1, a) * D2Bb(0, 2, b) + Bb(1, 1, a) * D2Bb(1, 2, b) +
             Bb(2, 1, a) * D2Bb(2, 2, b);
      lK(dof + 2, a, b) = lK(dof + 2, a, b) + w * BtDB;

      BtDB = Bb(0, 2, a) * D2Bb(0, 0, b) + Bb(1, 2, a) * D2Bb(1, 0, b) +
             Bb(2, 2, a) * D2Bb(2, 0, b);
      lK(2 * dof + 0, a, b) = lK(2 * dof + 0, a, b) + w * BtDB;

      BtDB = Bb(0, 2, a) * D2Bb(0, 1, b) + Bb(1, 2, a) * D2Bb(1, 1, b) +
             Bb(2, 2, a) * D2Bb(2, 1, b);
      lK(2 * dof + 1, a, b) = lK(2 * dof + 1, a, b) + w * BtDB;

      BtDB = Bb(0, 2, a) * D2Bb(0, 2, b) + Bb(1, 2, a) * D2Bb(1, 2, b) +
             Bb(2, 2, a) * D2Bb(2, 2, b);
      lK(2 * dof + 2, a, b) = lK(2 * dof + 2, a, b) + w * BtDB;
    }
  }
              ...
              const Array<double>& tfl, Array<double>& lR, Array3<double>& lK)
{
  ...
  for (int b = 0; b < eNoN; b++) {
    for (int a = 0; a < eNoN; a++) {
      auto lKp = gCov.col(0) * (N(b) * Nx(1, a) - N(a) * Nx(1, b)) -
                 gCov.col(1) * (N(b) * Nx(0, a) - N(a) * Nx(0, b));
...
//
void shl_strs_res(const ComMod& com_mod, const dmnType& lDmn, const int nFn,
...
#define n_debug_shl_strs_res
  ...
  for (int g = 0; g < 3; g++) {
    ...
    if (flag) {
      mat_models::get_pk2cc_shli(com_mod, lDmn, nFn, fNa0, gg_0, gg_x, g33, Sml,
                                 Dml);

      // For compressible materials
    } else {
      mat_models::get_pk2cc_shlc(com_mod, lDmn, nFn, fNa0, gg_0, gg_x, g33, Sml,
                                 Dml);
    }
