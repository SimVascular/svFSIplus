...
double integ(const ComMod& com_mod, const CmMod& cm_mod, int dId,
             const Array<double>& s, int l, int u, bool pFlag = false);

double integ(const ComMod& com_mod, const CmMod& cm_mod, const faceType& lFa,
             const Vector<double>& s, bool pFlag = false);

double integ(const ComMod& com_mod, const CmMod& cm_mod, const faceType& lFa,
             const Array<double>& s, const int l, int uo = -1,
             bool THflag = false);
...
void set_dmn_id(mshType& mesh, const int iDmn,
